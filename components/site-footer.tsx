        ...
        <footer className="wrapper mt-md flex flex-wrap items-center opacity-60 laptop:mt-xxl">
          ...
          <div className="flex w-full items-center gap-x-gutter">
            ...
            <li className="tick group relative flex h-nav text-xs uppercase hover:before:h-[12px]">
                <Link className="font-scor -ml-px flex items-center pr-lg" target="_self" rel="" href="/terms">
                  <p>Terms</p>
                </Link>
              </li>
              <li className="tick group relative flex h-nav text-xs uppercase hover:before:h-[12px]">
                <Link className="font-scor -ml-px flex items-center pr-lg" target="_self" rel="" href="/privacy">
                  <span>Privacy</span>
                </Link>
              </li>
              </ul>
          ...
          <div className="tick relative z-50 flex h-nav flex-1 items-center border-t text-xs uppercase laptop:flex-[0_0_25%]">
            <div className="relative">
              <Link className="tick flex h-nav w-lg items-center pr-sm" href="https://instagram.com/dogesoundclub" target="_blank" rel="noreferrer noopener">
            ...
            <div className="ml-auto font-scor">© DOGESOUNDCLUB
          </div>
          </div>
          </div>
        </div>
